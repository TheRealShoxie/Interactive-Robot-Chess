...
play chess with a robotic arm. The chess engine that will be utilized for this project will be a 3rd party library. 
These libraries will have the capability to be used, using a plug and play system, where you can add a different one 
...
showing additional backend information and the ability to change values within the system.\newline
...
\begin{itemize}
    ...
    \item \textbf{Test Results} -- This document will be a overview of test and experiment results. 
                  This is used to show all functionalities and safety features have been tested and 
                  achieved.
