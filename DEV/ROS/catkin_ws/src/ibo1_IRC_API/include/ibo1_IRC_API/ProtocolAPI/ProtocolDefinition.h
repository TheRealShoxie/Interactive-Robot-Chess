...
#define ERROR_CMD_PAWNCOLLIDEDSTRAIGHT              (BYTE)0xf5
#define ERROR_CMD_PAWNCOLLIDEDDIAGONALOREMPTYCELL   (BYTE)0xf4
#define ERROR_CMD_STARTINGCELLEMPTY                 (BYTE)0xf3
#define ERROR_CMD_NOTTHATCOLORSTURN                 (BYTE)0xf2
#define ERROR_CMD_MOVEINVALIDORBLOCKEDBYSAMECOLOR   (BYTE)0xf1
