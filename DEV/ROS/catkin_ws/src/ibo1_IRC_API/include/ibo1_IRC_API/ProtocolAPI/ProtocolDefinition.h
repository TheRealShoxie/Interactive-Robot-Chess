...
#define ERROR_CMD_PIECETOPROMOTEISNOTPAWN           (BYTE)0xed
#define ERROR_CMD_PAWNNOTMOVINGTOENDOFBOARD         (BYTE)0xec
#define ERROR_CMD_INVALIDPIECENAMETOPROMOTEINTO     (BYTE)0xeb

#define ERROR_CMD_CHESSENGINECREATEDNOMOVE          (BYTE)0xea

#define ERROR_CMD_INVALIDMOVEFORMAT                 (BYTE)0xe9
